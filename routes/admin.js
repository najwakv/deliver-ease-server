...
import { validateDriver, validateDriverId } from "../validators/driverValidators.js";
...
router.patch("/drivers/:driverId", adminAuthMiddleware, validateDriverId, updateDriver);
