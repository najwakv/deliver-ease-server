...
import { addCategory, addDriver, addProduct, addVendor, deleteDriver, deleteVendor, doLogin, getCategories, getCategory, getDriver, getDrivers, getVendor, getVendors, toggleBlockDriver, updateDriver, updateVendor } from "../controllers/adminController.js";
...
router.post("/product/addProduct", adminAuthMiddleware, addProduct);
